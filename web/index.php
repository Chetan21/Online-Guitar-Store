               ...
               <img src="images/slider1.jpg" class="img-responsive" alt=""/>
                ...
                <div class="slide_content">
                    <div class="slide_content_wrap">
                        <!-- Text title -->
                        <h1 class="title">Eternal<br>Music</h1>
                        <!-- /Text title -->
		...
		<div class="content-top">
			...
			<div class="close_but"><i class="close1"> </i></div>
				...
				<?php 
					...
					$sql = "SELECT guitar_image FROM guitar_details";
					...
					while($i<$count){
						...
						echo '<li><img src="data:image/jpeg;base64,'.base64_encode($guitar_image).'" /></li>';
						$i++;
					}
