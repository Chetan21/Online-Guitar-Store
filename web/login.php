				...
				<div class="col-md-6">
				 <div class="login-title">
					...
					<div id="loginbox" class="loginbox">
						<form action="auth.php" method="POST" name="login" id="login-form">
								...
								<?php
									...
									if($_SERVER['REQUEST_METHOD'] == 'POST') {	
										if (!isset($_POST['email']) || $_POST['email'] == "") {
											$errMsg = "Please enter your login email ID";
										}
									...
									if("" != $errMsg){
										...
										if(isset($_POST['email'])||isset($_POST['password'])){
											...
											$sql = "SELECT * FROM customer_details WHERE email_id = ".$email." AND password = ".$pword;
